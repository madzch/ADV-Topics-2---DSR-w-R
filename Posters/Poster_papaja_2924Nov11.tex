...
The authors made the following contributions. Madison Chin: Conceptualization, Writing - Original Draft Preparation, Writing - Review \& Editing.

Correspondence concerning this article should be addressed to Madison Chin. E-mail: \href{mailto:mjc611@scarletmail.rutgers.edu}{\nolinkurl{mjc611@scarletmail.rutgers.edu}}
...
Sometimes we want to cite papers (Syrett, Lu, \& Parrish, 2024).

Now we want to cite papers in Visual Mode (Syrett et al., 2024).
...
\begin{figure}
\centering
\includegraphics{Poster_papaja_2924Nov11_files/figure-latex/chickplot-1.pdf}
\caption{\label{fig:chickplot}(ref: chick- caption)}
\end{figure}
...
\bibitem[\citeproctext]{ref-syrett2024}
Syrett, K., Lu, J., \& Parrish, K. (2024). \emph{Perceptual benefits of linguistic diversity...}
