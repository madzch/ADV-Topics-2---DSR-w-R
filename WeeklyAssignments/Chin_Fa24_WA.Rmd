...
```
I wanted to have "TRUE ~ as.numeric(response)" instead of writing out response == 2,3,4, for efficiency. But, because this is a baser function and not dplyr, I stuck to a redundant implementation. 
```{r}
