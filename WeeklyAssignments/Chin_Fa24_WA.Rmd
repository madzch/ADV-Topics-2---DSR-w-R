...
# 2. Create a complete dataset to ensure all combinations of qualtrics_id and sub_types
#complete_rei_summary <- rei_summary %>%
  #complete(qualtrics_id, sub_type = c("EA", "EE", "RE", "RA"), fill = list(score = NA))
...
ggplot(combined_data, aes(x = sub_type, y = score, color = sub_type)) +
  geom_point() +
